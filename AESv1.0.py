...
input_label = ttk.Label(root, text="Plaintext/Ciphertext (Hex):", background=root.cget('bg'))
...
master_key_label = ttk.Label(root, text="Key (Hex):", background=root.cget('bg'))
...
#Hasil/Output
result_label = ttk.Label(root, text="Output (Hex):", background=root.cget('bg'))
...
copyright_label = tk.Label(root, text="© 2023 BukanMakmum.", font=("Helvetica", 8, "bold"), foreground="#FFF", cursor="hand2", background=root.cget('bg'))
